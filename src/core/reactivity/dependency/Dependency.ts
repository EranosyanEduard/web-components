...
class Dependency<T extends object> {
  private static readonly MagicProps = Object.freeze({
    TRACK_ALL: Symbol()
  } satisfies Record<string, symbol>)

  private readonly effects: Map<keyof T, Set<Effect>>

  private readonly effectsForProps: WeakMap<Effect, Set<keyof T>>
  ...
  private cleanup(effect: Effect): void {
